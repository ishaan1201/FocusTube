...
function Classroom() {
  ...
  useEffect(() => {
    ...
    loadInitial();
  }, [selectedClass, activeSearch, selectedSubject]);
...
const styles = {
  ...
  stickyNav: { position: "sticky", top: 0, zIndex: 50, background: "rgba(10, 10, 10, 0.95)", backdropFilter: "blur(10px)", borderBottom: "1px solid #222", padding: "15px 0" },
