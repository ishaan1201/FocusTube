...
import { Mail, Lock, User, Github, Chrome, ArrowRight, Loader2, ShieldCheck, Sparkles, LogIn, Monitor } from "lucide-react";
      ...
      >
        ...
        <div className="bg-zinc-900/40 backdrop-blur-2xl border border-white/5 p-8 rounded-[2rem] shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button onClick={() => handleOAuth('azure')} className="flex items-center justify-center gap-2 py-3 bg-white/5 border border-white/5 rounded-xl hover:bg-white/10 transition-all active:scale-95">
              <Monitor size={18} />
